...
# object compilation
if ( "${CMAKE_MAJOR_VERSION}.${CMAKE_VERSION_MINOR}" VERSION_LESS "3.4" )
    set(
...
else ( "${CMAKE_MAJOR_VERSION}.${CMAKE_VERSION_MINOR}" VERSION_LESS "3.4" )
        set(
            CMAKE_COGCXX_COMPILE_OBJECT
            "<CMAKE_COGCXX_COMPILER> <DEFINES> <INCLUDES> <FLAGS> -o <OBJECT> <SOURCE>"
            "${CMAKE_COMMAND} -DCMAKE_OBJCOPY=${CMAKE_OBJCOPY} -DOBJECT=<OBJECT> -P ${CMAKE_COGCXX_OBJCOPY}"
        )

endif ( "${CMAKE_MAJOR_VERSION}.${CMAKE_VERSION_MINOR}" VERSION_LESS "3.4" )
